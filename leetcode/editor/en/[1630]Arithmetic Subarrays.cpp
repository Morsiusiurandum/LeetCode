...
//
//
// Related Topics Array Sorting 👍 1375 👎 152
#include <algorithm>
#include <vector>
using namespace std;
...
{
public:
    static bool check(vector<int> &arr)
    {
    ...
    [[maybe_unused]] static vector<bool> checkArithmeticSubarrays(vector<int> &nums, vector<int> &l, vector<int> &r)
    {
        vector<bool> ans;
