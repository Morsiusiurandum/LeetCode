...
//
// Given an integer n and an integer array ranges of length n + 1 where ranges[
//i] (0-indexed) means the i-th tap can water the area [i - ranges[i], i + ranges[
//i]] if it was open. 
//
...
// 
//
// Related Topics Array Dynamic Programming Greedy 👍 2775 👎 154
#include <vector>
...
{
public:
    static int minTaps(int n, vector<int> &ranges)
    {
