...
//
//
//  Related Topics Array Hash Table 👍 2364 👎 617
...
{
public:
    [[maybe_unused]] static vector<vector<int>> groupThePeople(vector<int> &groupSizes)
    {
        ...
        for (int i = 0; i < groupSizes.size(); ++i)
        {
            ...
            // Commit as soon as the current group is stuffed
